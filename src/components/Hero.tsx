...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative overflow-hidden border-b border-white/10 bg-transparent">
      ...
      <div className="mx-auto grid min-h-[55vh] max-w-6xl items-center gap-8 px-6 py-6 sm:min-h-[75vh] sm:py-12 lg:min-h-[88vh] lg:grid-cols-12 lg:px-8 lg:py-20">
        <div className="lg:col-span-7">
          <div className="p-0 sm:p-4">
            <p className="mb-4 text-[11px] uppercase tracking-[0.35em] text-[#C6A85C]/80">
              Living Ecosystems
            </p>
